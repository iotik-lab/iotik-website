<x-app-layout>
    <div class="relative overflow-x-auto bg-white p-5 shadow-md sm:rounded-lg">
        ...
        <div class="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-4 2xl:gap-7.5">
            <!-- Card Item Start -->
            <div
                class="rounded-sm bg-slate-50 px-7 py-6 shadow-md dark:border-strokedark dark:bg-boxdark">
        ...
        {{-- <div class="basis-1/4 border rounded shadow-md p-8">
                <div class="flex gap-3 items-center">
                    <div class="w-[60px] flex items-center justify-center h-[60px] rounded-full bg-red-100">
                        <i class="fa-solid text-[25px] fa-temperature-three-quarters"></i>
                    </div>
                    <p class="">Inkubator</p>
                </div>
                <p class="text-4xl font-semibold text-red-600">1</p>
            </div> --}}
        {{-- <div class="basis-1/4 border rounded shadow-md p-8">
