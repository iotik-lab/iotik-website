<x-app-layout>
    ...
    <div class="relative overflow-x-auto bg-white p-5 shadow-md sm:rounded-lg">
        <div class="flex justify-between mb-5 items-center">
            <div class="flex items-center gap-5">
                ...
                <p class="text font-bold">Loading Image</p>
            </div>
        </div>

        <div
            class="mt-10 flex justify-center items-center gap-7 flex-col min-h-[70vh]"
        >
            <img
                src="/image/process_illust.svg"
                alt=""
                srcset=""
                class="w-[30%]"
            />

            <p class="mt-4">Gambar dalam proses...</p>
        </div>
    </div>
    ...
    @push("script")
        <script>
            ...
            ws.onopen = () => {
                ws.send(JSON.stringify({ device_id: 'candling' }))
            }
