            ...
            <tbody>
                @foreach ($images as $image)
                    ...
                    >
                        ...
                        <td class="px-6 py-4">
                            <img id="imagePredict" src="/storage/predicted/{{ $image['predicted_image']}}" class="w-[200px]" alt="">
                        </td>
                        <td class="px-6 py-4">
                            {{ $image["fertily"] }}
                        </td>
  ...
  <div id="default-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
      <div class="relative p-4 w-full max-w-2xl max-h-full">
          ...
          <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
              ...
              <!-- Modal body -->
              <div class="p-4 md:p-5 w-full h-full">
                  <img src="" id="imageModal" class=""  alt="">
    ...
    @push("script")
        <script>
            ...
            var images = $("#imageCandling")
            var imagesPredict = $("#imagePredict")
            images.click(function () {
                var id = $(this).attr("src")
                $("#default-modal").removeClass("hidden").addClass("flex");
                $("#imageModal").attr("src", id)
            })

            imagesPredict.click(function () {
                var id = $(this).attr("src")
                $("#default-modal").removeClass("hidden").addClass("flex");
                $("#imageModal").attr("src", id)
            })
