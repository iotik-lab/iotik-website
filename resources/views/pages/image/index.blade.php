<x-app-layout>
    ...
    <div class="relative overflow-x-auto bg-white p-5 shadow-md sm:rounded-lg">
        ...
        <div class="flex h-[400px] gap-2">
            <?php
            $eggs = [3, 6, 9, 12, 2, 5, 8, 11, 1, 4, 7, 10];
            ?>
            <div class="basis-1/2">
                <h1 class="text font-[700] mb-3">Control Lamp</h1>
                <div class="max-w-lg grid h-[350px] grid-cols-4 gap-4 rounded-lg shadow-lg px-10 py-8 border bg-white">
            ...
            <div class="basis-1/2">
                ...
                <embed type="video/webm" src="http://192.168.100.61/preview" class="border h-[350px] w-full">
            </div>
        </div>
        <button>asd</button>
