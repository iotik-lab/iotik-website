                ...
                <div class="w-[300px] rounded-md shadow-sm bg-yellow-50">
                    ...
                    <div class="flex justify-center mt-3">
                        <div class="flex gap-3 items-center">
                            ...
                            <p class="font-[800] lamp-text">Mati</p>
                        </div>
                    </div>
                    <div class="p-5">
                        @foreach ($incubator->devices as $device)
                            <div class="flex justify-between items-center bg-asd bg-white mb-3 rounded p-3 w-[100%]">
                                <div class="flex items-center gap-3">
                                    ...
                                    <p class="text font-[500]">{{ $device->type }}</p>
                                </div>
                                @if ($device->isOnline)
                                    <div class="relative">
                                        <div class="ping bg-green-300"></div>
                                        <span
                                            class="w-[20px] h-[20px] bottom-[5px] right-[5px] rounded-full bg-green-500 inline-block absolute"></span>
                                    </div>
                                @else
                                    <div class="relative">
                                        <div class="ping bg-red-300"></div>
                                        <span
                                            class="w-[20px] h-[20px] bottom-[5px] right-[5px] rounded-full bg-red-500 inline-block absolute"></span>
                                    </div>
                                @endif
                        ...
                        <div class="flex justify-center gap-5 mt-3 w-[100%]">
                            ...
                            <button type="button" data-modal-target="static-modal" data-modal-toggle="static-modal" onclick="addDevice('{{ $incubator->id }}')"
                            ...
                            <a href="{{ route('device.show', $incubator->id) }}"
                                ...
                                <i class="fa-solid fa-circle-info w-full text-blue-600"></i>
                            </a>
                        </div>
                    </div>
                </div>
    ...
    <div id="static-modal" data-modal-backdrop="static" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            ...
            <form action="{{ route('device.store') }}" method="POST">
                @csrf
                <input type="hidden" id="incubator_id" name="incubator_id">
                <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                    ...
                    <div class="p-4 md:p-5 space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="code" value="{{ old('code') }}" id="first_name"
