                    ...
                    <div class="p-5">
                        ...
                        <div class="flex justify-center gap-5 mt-3 w-[100%]">
                            <button
                                ...
                                onclick="addDevice('{{ $incubator->id }}')"
                    ...
                    <div class="p-4 md:p-5 space-y-4">
                        ...
                        <div>
                            ...
                            >
                                ...
                                @foreach (App\Enums\DeviceType::cases() as $item)
