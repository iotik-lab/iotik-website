...
>
    <div
        class="h-full px-6 py-5 pb-4 overflow-y-auto bg-white dark:bg-gray-800"
    >
        <ul class="space-y-2 font-medium">
            <li>
                <a
                    href="/dashboard"
                    class="sidebar-link group @active("dashboard.*")"
                >
                    <svg
            ...
            <li>
                <a
                    ...
                    class="sidebar-link group @active("record.*")"
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
            ...
            <li>
                ...
                href="{{ route("images.index") }}"
                    class="sidebar-link group @active("image.*")"
                >
                    <svg
                        xmlns="http://www.w3.org/2000/svg"
                        width="24"
